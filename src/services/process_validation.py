...
from models.process_model import ProcessInfo
...
def is_process_safe_to_terminate(
    ...
    try:
        ...
        if name in CRITICAL_LINUX_NAMES:
            return False, ValidationReason.CRITICAL_LINUX
...
def get_safe_to_terminate_processes(
